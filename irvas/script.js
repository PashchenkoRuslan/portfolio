...
const forms = state => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      if (item.getAttribite('data-calc') === 'end') {
...
__webpack_require__.r(__webpack_exports__);
const images = () => {
  const imgPopop = document.createElement('div'),
        workSection = document.querySelector('.works'),
        bigImage = document.createElement('img');
  imgPopop.classList.add('popup');
  workSection.appendChild(imgPopop);
  imgPopop.style.justifyContent = 'center';
  imgPopop.style.alignItems = 'center';
  imgPopop.style.display = 'none';
  imgPopop.appendChild(bigImage);
...
const modals = (a, b, c) => {
  function bindModal(triggerSelecetor, modalSelector, closeSelector) {
    ...
    const trigger = document.querySelectorAll(triggerSelecetor),
